...
class configPage(QMainWindow, Ui_MainWindow):
    ...
    def showBasebandStatistical(self, data):
        ...
        for i in range(20):
            ...
            SNRSub.append(self._calculateSNR(sigPwr, nosPwr, self.MType_rx_obj.currentIndex()))
    ...
    def _calculateSNR(self, sigPwr, nosPwr, mtype_index=None):
        ...
        if nosPwr == 0:
            return 50
        if mtype_index is not None and mtype_index == 3:
            return 10 * math.log10(sigPwr * math.pow(2, 10) / nosPwr)
        elif mtype_index is not None:
            return 10 * math.log10(sigPwr * math.pow(2, 6) / nosPwr)
        return 10 * math.log10(sigPwr / nosPwr)
    ...
    def killSSTimer(self):
        SSSystemThread.set_stopped()
        CorrValueThread.set_stopped()
        print("停止显示扩频数据")
        self.SStimer01.stop()
        self.SStimer02.stop()
