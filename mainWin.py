...
if __name__ == "__main__":
    ...
    statisticThread = UdpListenerThread(ipaddr, portStatistical)
    statisticThread.start()
    statisticThreadLDPC = UdpListenerThread(ipaddr, LDPCportStatistical)
    statisticThreadLDPC.start()
    spectrumThread = UdpListenerThread(ipaddr, SpectrumPortStatistical)
    spectrumThread.start()
    IQdataThread = UdpListenerThread(ipaddr, portIQ)
    IQdataThread.start()
    SSSystemThread = UdpListenerThread(ipaddr, portSSSys)
    SSSystemThread.start()
    CorrValueThread = UdpListenerThread(ipaddr, portCorrValue)
